...
export function ExpandableTabs({
  ...
  const SeparatorLine = () => (
    <div className="mx-1 h-[24px] w-[1.2px] bg-edge" aria-hidden="true" />
  );
  ...
  return (
    <div
      ref={outsideClickRef}
      className={cn(
        "flex flex-wrap items-center gap-2 rounded-2xl border border-edge bg-background p-1 shadow-sm",
        className
      )}
    >
      {tabs.map((tab, index) => {
